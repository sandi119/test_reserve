...
// Tesseract 설치 경로 (tesseract.exe가 있는 폴더)
const TESS_PATH = "C:\\Program Files\\Tesseract-OCR\\tesseract.exe";
// 언어 데이터 경로 (tessdata 폴더 위치) - ⭐️ 이 경로에 custom.traineddata 파일이 있어야 합니다.
...
// [함수] 캡차 인식 (Node.js Native - sharp & tesseract)
        ...
        return new Promise((resolve) => {
            execFile(
                ...
                [
                    processedPath,
                    "stdout",
                    "-l", "custom", // custom.traineddata 사용
                    "--psm", "13",  // Raw Line 모드
                ...
                if (isBooked) {
                    ...
                    if (captchaCode) {
                        ...
                        if (AUTO_SUBMIT) {
                            ...
                            console.log("[final] AUTO_SUBMIT=0 예약 버튼 클릭 대기 중");
                        }
                    } else {
